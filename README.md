...
Steps for how to publish documentation changes can be found [here](https://edunitas.com/kampus?gsf_by=d7bf08e6 ) in the (private) repository of the VS Code website.
